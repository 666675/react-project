    ...
    <div>
      <header>
        <nav className="section__container nav__container">
          <div className="nav__logo">ShreeBalaji<span>Hospital</span></div>
      ...
      <section className="section__container about__container" id="about">
        ...
        <div className="about__image">
          <img src="https://github.com/WebDesignMastery/HealthCare_22-07-23/blob/90dd52aa02bce2a3d1391078412a70dfdbd884ae/assets/about.jpg?raw=true" alt="about" />
        </div>
      </section>

      <section className="section__container why__container" id="blog">
        <div className="why__image">
          <img src="https://github.com/WebDesignMastery/HealthCare_22-07-23/blob/90dd52aa02bce2a3d1391078412a70dfdbd884ae/assets/choose-us.jpg?raw=true" alt="why choose us" />
        </div>
        ...
        <div className="doctors__grid">
          <div className="doctors__card">
            <div className="doctors__card__image">
              <img src="https://github.com/WebDesignMastery/HealthCare_22-07-23/blob/90dd52aa02bce2a3d1391078412a70dfdbd884ae/assets/doctor-1.jpg?raw=true" alt="doctor" />
          ...
          <div className="doctors__card">
            <div className="doctors__card__image">
              <img src="https://github.com/WebDesignMastery/HealthCare_22-07-23/blob/90dd52aa02bce2a3d1391078412a70dfdbd884ae/assets/doctor-2.jpg?raw=true" alt="doctor" />
              <div className="doctors__socials">
                <span><i className="ri-instagram-line"></i></span>
                <span><i className="ri-facebook-fill"></i></span>
                <span><i className="ri-heart-fill"></i></span>
          ...
          <div className="doctors__card">
            <div className="doctors__card__image">
              <img src="https://github.com/WebDesignMastery/HealthCare_22-07-23/blob/90dd52aa02bce2a3d1391078412a70dfdbd884ae/assets/doctor-3.jpg?raw=true" alt="doctor" />
              <div className="doctors__socials">
                <span><i className="ri-instagram-line"></i></span>
                <span><i className="ri-facebook-fill"></i></span>
                <span><i className="ri-heart-fill"></i></span>
      ...
      <footer className="footer">
        <div className="section__container footer__container">
          <div className="footer__col">
            <h3>Balaji<span>Hospital care</span></h3>
            <p>
          ...
          <div className="footer__col">
            <h4>Contact Us</h4>
            <p>
              <i className="ri-map-pin-2-fill"></i> 4-68/1, kandi village, X Road, sangareddy
            </p>
            <p><i className="ri-mail-fill"></i> care@travocure.com</p>
            <p><i className="ri-phone-fill"></i> (+91) 7045 798 938</p>
          </div>
        </div>
